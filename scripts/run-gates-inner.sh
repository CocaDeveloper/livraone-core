...
bash scripts/gates/gate_ui_ssot_contract.sh

bash scripts/gates/gate_auth_ui_alignment_contract.sh

bash scripts/gates/gate_ui_shell_adoption_contract.sh

bash scripts/gates/gate_hub_login_autostart_no_cta_contract.sh

bash scripts/gates/gate_theme_light_default_dark_optional_contract.sh
...
bash scripts/gates/gate_deploy_integrity_image_digest_contract.sh

bash scripts/gates/gate_ci_timing_regression_contract.sh

bash scripts/gates/gate_disable_next_telemetry_contract.sh

bash scripts/gates/gate_compose_integrity_contract.sh

bash scripts/gates/gate_phase_history_ledger_contract.sh
...
bash scripts/gates/gate_auth_login_cache_contract.sh

bash scripts/gates/gate_login_csrf_bootstrap_contract.sh
